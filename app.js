...
function sumAndMultiply(a, b, c) {
  //eslint-disable-line
  let sumTwo = sum(a,b)[0];
  let resultOfSum = sum(sumTwo, c)[0];
  let multiplyTwo = multiply(a,b)[0];
  let resultOfmultipling = multiply(multiplyTwo, c)[0];
  return [resultOfSum, resultOfmultipling , `${a} and ${b} and ${c} sum to ${resultOfSum}.`, `The product of ${a} and ${b} and ${c} is ${resultOfmultipling}.` ]
}

// Here is the test for sumAndMultiply(); uncomment it to run  it
 testSumAndMultiply(4,7,5);

// Once you get the test passing, 
// do an a-c-p cycle and synchronize the code between GitHub and your laptop.
...
function sumArray(sumArr) {
  ...
  return [resultOfSum, `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${resultOfSum} is their sum.`];
...
function multiplyAnyArray(dynamicArray) {
  let dynamicMultiplication ;
  for (let i = 0; i<dynamicArray.length; i++){
    dynamicMultiplication =  multiply(dynamicArray[i], dynamicArray[i+1])[0];
      }
  console.log(dynamicMultiplication);
  return[dynamicMultiplication, `The numbers ${dynamicArray[0]}, ${dynamicArray[1]}, ${dynamicArray[2]}, ${dynamicArray[3]}, ${dynamicArray[4]} have a product of ${dynamicMultiplication}`];
  // eslint-disable-line
}
