...
returns an array where the first element is the sum of those three numbers, the second element 
is the product of those three numbers,  and the third and fourth elements are strings that EXACTLY 
...
function sumArray(sumArr) {
  ...
  //eslint-disable-line
  let sum01 = sum(sumArr[0], sumArr[1])[0]
  let sum02 = sum(sum01, sumArr[2])[0]
  return [sum02, `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${sum02} is their sum.`]
}
...
function multiplyArray(multArr) {
  ...
  let multi01 = multiply(multArr[0], multArr[1])[0]
  let multi02 = multiply(multi01, multArr[2])[0]

  return [multi02, `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${multi02}.`]
...
function multiplyAnyArray(dynamicArray) {
  //eslint-disable-line
let multi05 = 1;
 // let multi05 = multiply(dynamicArray[0],120);

  for (let i = 0; i < 5; i++) {
     multi05 = multiply(multi05, dynamicArray[i])[0]; 
  }
  return [multi05, `The numbers ${dynamicArray[0]},${dynamicArray[1]},${dynamicArray[2]},${dynamicArray[3]},${dynamicArray[4]} have a product of 120.`]
}
